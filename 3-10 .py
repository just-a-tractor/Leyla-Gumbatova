...
from PyQt5.QtWidgets import QLabel, QLineEdit, QComboBox, QRadioButton
    ...
    def find(self):
        ...
        if response:
            ...
            try:
                ...
                toponym1 = toponym['metaDataProperty']['GeocoderMetaData']['text']
            ...
            try:
                if not self.radio:
                    raise IndexError
                index = toponym['metaDataProperty']['GeocoderMetaData']['AddressDetails']['Country']['AdministrativeArea']['Locality']['Thoroughfare']['Premise']['PostalCode']['PostalCodeNumber']
            except Exception as e:
                 index = ' '
